...
function dateFormat(date: Date) {
    return new Date(date.getTime() - new Date().getTimezoneOffset() * 60000).toLocaleString("pt-BR").substr(0, 10);
}
</script>

<template>
    <div
        class="character-register"
        :class="{
    ...
    >
        <div class="characters-register-block-header">
            ...
            <span id="close-reg" class="material-symbols-outlined" @click="close()"> close </span>
        </div>
